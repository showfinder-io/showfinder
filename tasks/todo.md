...
- [ ] D13. SHORTLIST 2 à cadrer (demande Julien 2026-08-05, à lancer en session fraîche). Méthode identique à la shortlist 1 (voir tasks/cohorte-trafic-shortlist.md, section Synthèse + D1-D3 ci-dessus) :
  1. Export catalogue frais (REST salons, 224 publiés) pour exclure l'existant, y compris les 33 fiches des lots 1-6 et les slugs draft.
  2. Demande GSC non couverte : dernière baseline audits/gsc-baseline-*/queries.csv (la plus récente disponible), requêtes nommant un salon sans fiche.
  3. Recherche web par sous-agents Sonnet en parallèle, 3 zones (IDF ; Lyon/Grand Ouest ; Sud/Nord/Est) sur une fenêtre ÉLARGIE : janvier 2027 à juin 2028, sources primaires uniquement (calendriers Viparis, Eurexpo/GL events, Exponantes, MEETT, Parc Chanot, Lille Grand Palais, Strasbourg, Unimev), en écartant les 36 candidats de la shortlist 1 et les 3 P3 (Prodays, Patrimonia Paris, Salon du Brasseur Nancy).
  4. Cible 40-60 candidats P1/P2/P3 avec URL officielle vérifiée par fetch, dates, signal GSC ou notoriété. Livrable : tasks/cohorte-trafic-shortlist-2.md, PR, puis validation Julien avant écriture.
  Règle #13 : aucune donnée non vérifiée en P1/P2. Pipeline d'écriture ensuite inchangé (writer Opus + 2 reviewers Sonnet + EN, scripts/diag-cohorte-trafic-apply.ts, lots de 5 à 7).
